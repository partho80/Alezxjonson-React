                ...
                <div className="row hero-row">
                    ...
                    <div className="col-xl-8 col-lg-6">
                        <div className="hero-area-content">
                            ...
                            <div className="social-box mobile-show">
                    ...
                    <div className="col-lg-4 mobile-hide hero-2-right">
                        <div className="hero-2-right-img">
                            <img src="assets/img/hero-img.jpg" alt=""/>
                        </div>
                        <div className="social-box">
                            ...
                            <ul className="social-collection">
                                ...
                                <li><a href="https://www.pinterest.com/"><i className="fa-brands fa-pinterest-p"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
